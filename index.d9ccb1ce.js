...
z="(?:\\\\[\\da-fA-F]{1,6}"+D+"?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+",O="\\["+D+"*("+z+")(?:"+D+// Operator (capture 2)
"*([*^$|!~]?=)"+D+// "Attribute values must be CSS identifiers [capture 5] or strings [capture 3 or capture 4]"
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+z+"))|)"+D+"*\\]",Y=":("+z+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+O+")*)|.*)\\)|)",M=RegExp(D+"+","g"),N=RegExp("^"+D+"*,"+D+"*"),R=RegExp("^"+D+"*([>+~]|"+D+")"+D+"*"),j=RegExp(D+"|>"),W=new RegExp(Y),B=RegExp("^"+z+"$"),q={ID:RegExp("^#("+z+")"),CLASS:RegExp("^\\.("+z+")"),TAG:RegExp("^("+z+"|[*])"),ATTR:RegExp("^"+O),PSEUDO:RegExp("^"+Y),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+D+"*(even|odd|(([+-]|)(\\d*)n|)"+D+"*(?:([+-]|)"+D+"*(\\d+)|))"+D+"*\\)|)","i"),bool:RegExp("^(?:"+L+")$","i"),// For use in libraries implementing .is()
...
J.compile=td,J.select=tf,J.setDocument=tr,J.tokenize=tl,J.escape=T.escapeSelector,J.getText=T.text,J.isXML=T.isXMLDoc,J.selectors=T.expr,J.support=T.support,J.uniqueSort=T.uniqueSort;/* eslint-enable */}();var X=function(t,e,i){for(var n=[],o=void 0!==i;(t=t[e])&&9!==t.nodeType;)if(1===t.nodeType){if(o&&T(t).is(i))break;n.push(t)}return n},L=function(t,e){for(var i=[];t;t=t.nextSibling)1===t.nodeType&&t!==e&&i.push(t);return i},z=T.expr.match.needsContext,O=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;// Implement the identical functionality for filter and not
function Y(t,e,i){return m(e)?T.grep(t,function(t,n){return!!e.call(t,n,t)!==i}):e.nodeType?T.grep(t,function(t){return t===e!==i}):"string"!=typeof e?T.grep(t,function(t){return l.call(e,t)>-1!==i}):T.filter(e,t,i)}T.filter=function(t,e,i){var n=e[0];return(i&&(t=":not("+t+")"),1===e.length&&1===n.nodeType)?T.find.matchesSelector(n,t)?[n]:[]:T.find.matches(t,T.grep(e,function(t){return 1===t.nodeType}))},T.fn.extend({find:function(t){var e,i,n=this.length,o=this;if("string"!=typeof t)return this.pushStack(T(t).filter(function(){for(e=0;e<n;e++)if(T.contains(o[e],this))return!0}));for(e=0,i=this.pushStack([]);e<n;e++)T.find(t,o[e],i);return n>1?T.uniqueSort(i):i},filter:function(t){return this.pushStack(Y(this,t||[],!1))},not:function(t){return this.pushStack(Y(this,t||[],!0))},is:function(t){return!!Y(this,// so $("p:first").is("p:last") won't return true for a doc with two "p".
"string"==typeof t&&z.test(t)?T(t):t||[],!1).length}});// Initialize a jQuery object
...
T.merge(this,T.parseHTML(n[1],e&&e.nodeType?e.ownerDocument||e:v,!0)),O.test(n[1])&&T.isPlainObject(e))for(n in e)m(this[n])?this[n](e[n]):this.attr(n,e[n]);return this}return!e||e.jquery?(e||i).find(t):this.constructor(e).find(t);// HANDLE: $(DOMElement)
...
if(!z.test(t)){for(;n<o;n++)for(i=this[n];i&&i!==e;i=i.parentNode)if(i.nodeType<11&&(r?r.index(i)>-1:1===i.nodeType&&T.find.matchesSelector(i,t))){s.push(i);break}}return this.pushStack(s.length>1?T.uniqueSort(s):s)},// Determine the position of an element within the set
...
function tz(t){return t.type=(null!==t.getAttribute("type"))+"/"+t.type,t}function tO(t){return"true/"===(t.type||"").slice(0,5)?t.type=t.type.slice(5):t.removeAttribute("type"),t}function tY(t,e){var i,n,o,s,r,a;if(1===e.nodeType){// 1. Copy private data: events, handlers, etc.
...
for(l=(a=T.map(tw(o,"script"),tz)).length;u<p;u++)c=o,u!==d&&(c=T.clone(c,!0,!0),l&&// push.apply(_, arraylike) throws on ancient WebKit
...
T.map(a,tO),u=0;u<l;u++)c=a[u],tb.test(c.type||"")&&!tn.access(c,"globalEval")&&T.contains(h,c)&&(c.src&&"module"!==(c.type||"").toLowerCase()?T._evalUrl&&!c.noModule&&T._evalUrl(c.src,{nonce:c.nonce||c.getAttribute("nonce")},h):// needed as in XML documents they're already not visible when
...
if(e){if(i)for(n=0,s=s||tw(t),r=r||tw(a),o=s.length;n<o;n++)tY(s[n],r[n]);else tY(t,a)}// Return the cloned set
...
(l+=Math.max(0,Math.ceil(t["offset"+e[0].toUpperCase()+e.slice(1)]-s-l-a-.5))||0),l+c}function t3(t,e,i){// Start with computed style
...
(r=parseFloat(r)||0)+t1(t,e,i||(o?"border":"content"),s,n,r)+"px"}function t2(t,e,i,n,o){return new t2.prototype.init(t,e,i,n,o)}T.extend({// Add in style property hooks for overriding the default
...
t.getClientRects().length&&t.getBoundingClientRect().width?t3(t,e,n):tB(t,tZ,function(){return t3(t,e,n)})},set:function(t,i,n){var o,s=tW(t),// to avoid forcing a reflow.
...
t2.propHooks.scrollTop=t2.propHooks.scrollLeft={set:function(t){t.elem.nodeType&&t.elem.parentNode&&(t.elem[t.prop]=t.now)}},T.easing={linear:function(t){return t},swing:function(t){return .5-Math.cos(t*Math.PI)/2},_default:"swing"},T.fx=t2.prototype.init,// Back compat <1.8 extension point
...
// Fixes trac-9887
function ez(t,e){var i,n,o=T.ajaxSettings.flatOptions||{};for(i in e)void 0!==e[i]&&((o[i]?t:n||(n={}))[i]=e[i]);return n&&T.extend(!0,t,n),t}eH.href=ef.href,T.extend({// Counter for holding the number of active queries
...
ajaxSetup:function(t,e){return e?ez(ez(t,T.ajaxSettings),e):ez(T.ajaxSettings,t)},ajaxPrefilter:eX(eD),ajaxTransport:eX(eI),// Main method
...
i=function(t){return function(){i&&(i=n=a.onload=a.onerror=a.onabort=a.ontimeout=a.onreadystatechange=null,"abort"===t?a.abort():"error"===t?"number"!=typeof a.status?s(0,"error"):s(a.status,a.statusText):s(eO[a.status]||a.status,a.statusText,"text"!==// IE9 has no XHR2 but throws on binary (trac-11426)
...
(n=(e=v.implementation.createHTMLDocument("")).createElement("base")).href=v.location.href,e.head.appendChild(n)):e=v),o=O.exec(t),s=!i&&[],o)?[e.createElement(o[1])]:(o=tk([t],e,s),s&&s.length&&T(s).remove(),T.merge([],o.childNodes))},/**
...
tu.css({"-ms-touch-action":"","touch-action":""}),n.length&&ts.scrollTop(n.position().top))}/**
        ...
        */function tA(){var e=t(y).prev(v);!e.length&&(M.loopTop||M.continuousVertical)&&(e=t(v).last()),e.length&&t3(e,null,!0)}/**
        * Moves the page down one section.
        */function tD(){var e=t(y).next(v);!e.length&&(M.loopBottom||M.continuousVertical)&&(e=t(v).first()),e.length&&t3(e,null,!1)}/**
        * Moves the page to the given section and slide with no animation.
        * Anchors or index positions can be used as params.
        */function tI(t,e){tT(0,"internal"),t_(t,e),tT(tb.scrollingSpeed,"internal")}/**
        * Moves the page to the given section and slide.
        * Anchors or index positions can be used as params.
        */function t_(t,e){var i=eS(t);void 0!==e?ew(t,e):i.length>0&&t3(i)}/**
...
td=!0,tp=U.height(),t(v).each(function(){var e=t(this).find(_),i=t(this).find(A);M.verticalCentered&&t(this).find(w).css("height",ex(t(this))+"px"),t(this).css("height",tp+"px"),i.length>1&&ec(e,e.find(D))}),M.scrollOverflow&&Z.createScrollBarForAll();var i=t(y).index(v);i&&tI(i+1),td=!1,t.isFunction(M.afterResize)&&e&&M.afterResize.call(tu),t.isFunction(M.afterReBuild)&&!e&&M.afterReBuild.call(tu)}}/**
        ...
        */function tz(e){var i=tr.hasClass(a);e?!i&&(tS(!1,"internal"),tE(!1,"internal"),t(E).hide(),tr.addClass(a),t.isFunction(M.afterResponsive)&&M.afterResponsive.call(tu,e)):i&&(tS(tb.autoScrolling,"internal"),tE(tb.autoScrolling,"internal"),t(E).show(),tr.removeClass(a),t.isFunction(M.afterResponsive)&&M.afterResponsive.call(tu,e))}/**
        * Actions and callbacks to fire afterRender
        */function tO(){var e,i=t(y);i.addClass(f),t4(i),t8(i),M.scrollOverflow&&M.scrollOverflowHandler.afterLoad(),(!(e=eS(ei().section))||e.length&&e.index()===Q.index())&&t.isFunction(M.afterLoad)&&M.afterLoad.call(i,i.data("anchor"),i.index(v)+1),t.isFunction(M.afterRender)&&M.afterRender.call(tu)}eL(),//easeInOutCubic animation included in the plugin
...
ta.version="2.9.6",ta.setAutoScrolling=tS,ta.setRecordHistory=tw,ta.setScrollingSpeed=tT,ta.setFitToSection=tE,ta.setLockAnchors=/**
        * Sets lockAnchors
        */function(t){M.lockAnchors=t},ta.setMouseWheelScrolling=tk,ta.setAllowScrolling=tP,ta.setKeyboardScrolling=tC,ta.moveSectionUp=tA,ta.moveSectionDown=tD,ta.silentMoveTo=tI,ta.moveTo=t_,ta.moveSlideRight=tH,ta.moveSlideLeft=tX,ta.fitToSection=tR,ta.reBuild=tL,ta.setResponsive=tz,ta.destroy=/*
        * Destroys fullpage.js plugin events and optinally its html markup and styles
        */function(e){//removing selectors
var i;tS(!1,"internal"),tP(!1),tC(!1),tu.addClass(c),clearTimeout(te),clearTimeout(tt),clearTimeout(J),clearTimeout(ti),clearTimeout(tn),U.off("scroll",tN).off("hashchange",ee).off("resize",ep),$.off("keydown",en).off("keyup",eo).off("click touchstart",E+" a").off("mouseenter",E+" li").off("mouseleave",E+" li").off("click touchstart",Y).off("mouseover",M.normalScrollElements).off("mouseout",M.normalScrollElements),t(v).off("click touchstart",N),clearTimeout(te),clearTimeout(tt),e&&(//reseting the `top` or `translate` properties to 0
eI(0),//loading all the lazy load content
tu.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function(){t5(t(this),"src")}),tu.find("img[data-srcset]").each(function(){t5(t(this),"srcset")}),t(E+", "+O+", "+N).remove(),//removing inline styles
...
ta.shared={afterRenderActions:tO},M.css3&&(M.css3=/**
...
s.data("fp-styles",s.attr("style")),e||0!==t(y).length||s.addClass(p),Q=t(y),s.css("height",tp+"px"),M.paddingTop&&s.css("padding-top",M.paddingTop),M.paddingBottom&&s.css("padding-bottom",M.paddingBottom),void 0!==M.sectionsColor[e]&&s.css("background-color",M.sectionsColor[e]),void 0!==M.anchors[e]&&s.attr("data-anchor",M.anchors[e]),void 0!==M.anchors[e]&&s.hasClass(p)&&eg(M.anchors[e],e),M.menu&&M.css3&&t(M.menu).closest(r).length&&t(M.menu).appendTo(tr),l>0?(i=100*l,n=100/l,a.wrapAll('<div class="'+H+'" />'),a.parent().wrap('<div class="'+I+'" />'),s.find(X).css("width",i+"%"),l>1&&(M.controlArrows&&(s.find(_).after('<div class="'+W+'"></div><div class="'+F+'"></div>'),"#fff"!=M.controlArrowColor&&(s.find(V).css("border-color","transparent transparent transparent "+M.controlArrowColor),s.find(B).css("border-color","transparent "+M.controlArrowColor+" transparent transparent")),M.loopHorizontal||s.find(B).hide()),M.slidesNavigation&&/**
        ...
        */function(t,e){t.append('<div class="'+z+'"><ul></ul></div>');var i=t.find(O);//top or bottom
...
t(E).find("li").eq(t(y).index(v)).find("a").addClass(p)}(),tu.find('iframe[src*="youtube.com/embed/"]').each(function(){/**
        ...
        */(function(t,e){var i=t.attr("src");t.attr("src",i+(/\?/.test(i)?"&":"?")+e)})(t(this),"enablejsapi=1")}),M.scrollOverflow?Z=M.scrollOverflowHandler.init(M):tO(),tP(!0),tS(M.autoScrolling,"internal"),ed(),//setting the class for the body element
...
function(e){e.preventDefault();var i=t(this).parent().index();t3(t(v).eq(i))})//Scrolls the slider to the given slide destination for the given section
.on("click touchstart",Y,//Scrolls the slider to the given slide destination for the given section
...
function(){var e=t(this).closest(v);t(this).hasClass(R)?tv.m.left&&tX(e):tv.m.right&&tH(e)}),M.normalScrollElements&&($.on("mouseenter touchstart",M.normalScrollElements,function(){tP(!1)}),$.on("mouseleave touchend",M.normalScrollElements,function(){tP(!0)})));var tY=!1,tM=0;//when scrolling...
...
(e=t(l).eq(s)).hasClass(p)){tY=!0;var h,u,d,m,g,x=t(y),b=x.index(v)+1,S=ev(e),w=e.data("anchor"),T=e.index(v)+1,E=e.find(D);E.length&&(g=E.data("anchor"),m=E.index()),tm&&(e.addClass(p).siblings().removeClass(p),t.isFunction(M.onLeave)&&M.onLeave.call(x,b,T,S),t.isFunction(M.afterLoad)&&M.afterLoad.call(e,w,T),t6(x),t4(e),t8(e),eg(w,T-1),M.anchors.length&&(q=w),eE(m,g,w,T)),//small timeout in order to avoid entering in hashChange event when scrolling is not finished yet
clearTimeout(ti),ti=setTimeout(function(){tY=!1},100)}M.fitToSection&&(//for the auto adjust of the viewport to fit a whole section
...
if(!M.loopHorizontal)return;r="left"===e?s.siblings(":last"):s.siblings(":first")}tl=!0,ec(n,r,e)}}/**
        ...
        */function t3(e,i,o){if(void 0!==e){//there's no element to scroll, leaving the function
...
if(M.css3&&M.autoScrolling&&!M.scrollBar)eb("translate3d(0px, -"+n.round(e.dtop)+"px, 0px)",!0),M.scrollingSpeed?(clearTimeout(tt),tt=setTimeout(function(){t2(e)},M.scrollingSpeed)):t2(e);else{var i,o=(i={},M.autoScrolling&&!M.scrollBar?(i.options={top:-e.dtop},i.element=r):(i.options={scrollTop:e.dtop},i.element="html, body"),i);t(o.element).animate(o.options,M.scrollingSpeed,M.easing).promise().done(function(){M.scrollBar?/* Hack!
                        The timeout prevents setting the most dominant section in the viewport as "active" when the user
                        scrolled to a smaller section by using the mousewheel (auto scrolling) rather than draging the scroll bar.

                        When using scrollBar:true It seems like the scroll events still getting propagated even after the scrolling animation has finished.
                        */setTimeout(function(){t2(e)},30):t2(e)})}}(m),//flag to avoid callingn `scrollPage()` twice in case of using anchor links
q=m.anchorLink,//avoid firing it twice (as it does also on scroll)
eg(m.anchorLink,m.sectionIndex)}}}/**
        * Actions to do once the section is loaded.
        */function t2(e){e.wrapAroundElements&&e.wrapAroundElements.length&&(e.isMovementUp?t(x).before(e.wrapAroundElements):t(b).after(e.wrapAroundElements),eI(t(y).position().top),// Maintain the active slides visible in the viewport
...
i.find('iframe[src*="youtube.com/embed/"]').each(function(){var e=t(this).get(0);/youtube\.com\/embed\//.test(t(this).attr("src"))&&!e.hasAttribute("data-keepplaying")&&t(this).get(0).contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})}/**
        ...
        * (a way to detect back history button as we play with the hashes on the URL)
        */function ee(){if(!tY&&!M.lockAnchors){var t=ei(),e=t.section,i=t.slide,n=void 0===q,o=void 0===q&&void 0===i&&!tl;e&&e.length&&(e&&e!==q&&!n||o||!tl&&G!=i)&&ew(e,i)}}//gets the URL anchors (section and slide)
...
t===q||i.hasClass(p)?eT(s):t3(i,function(){eT(s)})}}/**
...
"all"!==i?tv[n][i]=e:t.each(Object.keys(tv[n]),function(t,i){tv[n][i]=e})}/*
        ...
        * Displays warnings
        */function eL(){if(t("html").hasClass(h)){ez("error","Fullpage.js can only be initialized once and you are doing it multiple times!");return}M.continuousVertical&&(M.loopTop||M.loopBottom)&&(M.continuousVertical=!1,ez("warn","Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),M.scrollBar&&M.scrollOverflow&&ez("warn","Option `scrollBar` is mutually exclusive with `scrollOverflow`. Sections with scrollOverflow might not work well in Firefox"),M.continuousVertical&&(M.scrollBar||!M.autoScrolling)&&(M.continuousVertical=!1,ez("warn","Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),M.scrollOverflow&&!M.scrollOverflowHandler&&(M.scrollOverflow=!1,ez("error","The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")),//using extensions? Wrong file!
