export default {
  ...
  'Plot area': 'Plot area',
  'VILLA_150_DESCRIPTION': 'Elegant medium-sized housing format, where the façade finishes contrast spectacularly with the surrounding greenery.',
  villa: 'villa',
  VILLA_100_DESCRIPTION: 'Elegant medium-sized housing format, where the façade finishes contrast spectacularly with the surrounding greenery.',
  ...
  'VILLA_200_DESCRIPTION': 'Elegant medium-sized housing format, where the façade finishes contrast spectacularly with the surrounding greenery.',
